...
abstract class AbsRecyclerView {
    abstract class ListAdapter<ITEM : Any, B : ViewDataBinding>(
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
            object : ViewHolder<B>(layoutRes = layoutRes, parent = parent, bindingVariableId = bindingVariableId) {}
    ...
    abstract class Adapter<ITEM : Any, B : ViewDataBinding>(
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = object : ViewHolder<B>(layoutRes = layoutRes, parent = parent, bindingVariableId = bindingVariableId) {}
    ...
    abstract class ViewHolder<out B : ViewDataBinding>(
        ...
        fun onBindViewHolder(item: Any?) {
            try {
                binding.run {
                    bindingVariableId?.let { setVariable(it, item) }
